...
WeatherInfoResponseModel _$WeatherInfoResponseModelFromJson(
    ...
    WeatherInfoResponseModel(
      ...
      weatherDescription: (json['weather'] as List<dynamic>?)
          ...
          .toList(),
      mainWeatherData: json['mainWeatherData'] == null
          ? null
      ...
      cloudData: json['clouds'] == null
          ? null
          : CloudResponseModel.fromJson(json['clouds'] as Map<String, dynamic>),
