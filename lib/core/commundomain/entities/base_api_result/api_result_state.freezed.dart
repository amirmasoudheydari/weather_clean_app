...
abstract class Data<T> implements ApiResultState<T> {
  factory Data({required final T data}) = _$DataImpl<T>;
...
class _$ErrorImpl<T> implements Error<T> {
  _$ErrorImpl({required this.errorResultModel});
...
abstract class Error<T> implements ApiResultState<T> {
  factory Error({required final ErrorResultModel errorResultModel}) =
      _$ErrorImpl<T>;
